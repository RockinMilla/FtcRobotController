...
public class AutoDriveBlue extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        telemetry.addData("This code was last updated", "09/28/2025, 4:56 pm"); // Todo: Update this date when the code is updated
        ...
        // correct up to here
        r.driveToPos(500, 600, 45); // strafe right
        r.driveToPos(500, 600, 90); // turn right
        r.driveToPos(200, 200, 90); // forward (intake balls)
        sleep(1000); // slurp up balls
