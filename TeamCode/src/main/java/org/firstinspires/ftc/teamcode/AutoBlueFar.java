...
public class AutoBlueFar extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        telemetry.addData("This code was last updated", "1/07/2025, 2:27 pm"); // Todo: Update this date when the code is updated
        telemetry.update();
