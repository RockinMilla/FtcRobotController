...
public class AutoBlueClose extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        telemetry.addData("This code was last updated", "1/16/2026, 3:02 pm"); // Todo: Update this date when the code is updated
        telemetry.update();
        ...
        r.driveToPos(-1390, 150, 0, 10, 2, 1.5);
        r.waitForLifter();
        sleep(100);
        ...
        r.driveToPos(-1920,150,0,10,2,2);
        r.waitForLifter();
        sleep(100);

        r.launcherVelocity(0);
        r.driveToPos(-1880,-300,0,10,1,3);
        r.driveToPos(-1100, -300, 0, 25, 2, 3); // Park
        r.driveToPos(-1100, -300, 0, 20, 1, 3); // Park more accurately
        r.intakePower(0);
    }
    ...
    private void shootBalls(RockinBot r)
    {
        ...
        r.driveToPos(-100, -700, -33, 20, 1, 5); // Intentionally repeated
